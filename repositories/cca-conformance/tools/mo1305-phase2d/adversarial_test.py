"""Bounded Phase 2D package attacks against independent archive/file constraints."""
...
def run(archive, output, node=None):
    ...
    with tempfile.TemporaryDirectory(prefix='memoryos-rest-phase2d-adversarial-') as directory:
    ...
    result = {'kind': 'MemoryOSRESTPhase2DPackageAdversarial', 'version': '1.0.0', 'state': 'PASS',
