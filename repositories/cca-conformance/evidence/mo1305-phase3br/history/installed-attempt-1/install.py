...
''', encoding='utf-8')
        ...
        for label, package in [('npm-offline-install', installed)]:
            ...
            persistence_before = {name: inventory(stage / name) for name in ('project', 'empty', 'tmp', 'private', 'fixtures', 'home')}
            ...
            persistence_after = {name: inventory(stage / name) for name in persistence_before}
