...
def run(archive):
    ...
    return {'kind':'MemoryOSRESTReleaseMetadataTests','version':'1.0.0','state':'PASS','archive':identity(data),'caseCount':len(cases),'cases':cases,'spdx':verify_spdx(sbom,files)}
