...
export async function foundationInventory() {
  ...
  const members = ['package.json', 'package-lock.json', 'README.md', 'NOTICE.md'];
  ...
  return {kind:'MemoryOSMCPDistributionFoundation',version:'1.0.0',status:'PHASE1_FOUNDATION_NOT_ARCHIVE_CERTIFICATION',
    ...
    archive:{status:'PENDING_PHASE2',sha256:null,byteLength:null},developmentDependenciesIncluded:false,
